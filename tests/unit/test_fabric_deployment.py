...
class TestFabricDeployer:
    ...
    def test_generate_dbt_project_yml(self, tmp_path):
        ...
        deployer = FabricDeployer()
        deployer._generate_dbt_project_yml(config, config.projects["default"], output_dir)
    ...
    def test_generate_profiles_yml(self, tmp_path):
        ...
        assert dev_output["catalog"] == "test-fabric_data_prod_test"  # Auto-generated catalog name
    ...
    def test_generate_readme(self, tmp_path):
        ...
        assert "Default test project" in readme_content  # Project description, not fabric description
    ...
    def test_package_summary_methods(self):
        ...
        from dbt_projects_cli.schemas.fabric import GitPackage, LocalPackage, HubPackage
    ...
    def test_deploy_with_temp_directory(self, mock_mkdtemp, tmp_path):
        ...
        deployer = FabricDeployer()
        result_path = deployer.deploy(config_file, "default", output_dir=None, dry_run=False)
    ...
    def test_deploy_with_specified_output_dir(self, tmp_path):
        ...
        deployer = FabricDeployer()
        result_path = deployer.deploy(config_file, "default", output_dir=output_dir, dry_run=False)
