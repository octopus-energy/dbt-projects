...
class TestDatabricksConnection:
    ...
    def test_valid_databricks_connection(self):
        ...
        connection = DatabricksConnection(
            host="my-workspace.cloud.databricks.com", auth_type="oauth"
        )
    ...
    def test_databricks_connection_defaults(self):
        ...
        connection = DatabricksConnection(host="my-workspace.cloud.databricks.com")
    ...
    def test_valid_azure_databricks_host(self):
        ...
        connection = DatabricksConnection(host="my-workspace.azuredatabricks.net")
...
class TestPackageSchemas:
    ...
    def test_hub_package(self):
        ...
        package = HubPackage(package="elementary-data/elementary", version=">=0.16.4")
...
class TestFabricConfig:
    ...
    def test_fabric_config_project_name_mismatch(self):
        ...
        assert "Project name 'different-name' does not match key 'core'" in str(
            exc_info.value
        )
    ...
    def test_get_catalog_name(self):
        ...
        assert (
            config.get_catalog_name("source") == "octoenergy_data_prod_data_prod_source"
        )
...
class TestMultipleFabricsConfig:
    ...
    def test_multiple_fabrics_name_mismatch(self):
        ...
        config_dict = self.get_valid_multiple_fabrics_dict()
        config_dict["fabrics"]["octoenergy_data_prod"]["fabric"][
            "name"
        ] = "different-name"
        ...
        assert (
            "Fabric name 'different-name' does not match key 'octoenergy_data_prod'"
...
class TestLegacyFabricConfig:
    ...
    def get_valid_legacy_config_dict(self):
        ...
        return {
            "fabric": {"name": "test-fabric", "description": "A test fabric"},
            "databricks": {
