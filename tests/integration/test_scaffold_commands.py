...
class TestScaffoldCommands:
    ...
    def test_scaffold_domain_source_aligned(self):
        ...
        result = runner.invoke(cli, [
            ...
            '--description', 'Test source-aligned package'
        ])
    ...
    def test_scaffold_domain_consumer_aligned(self):
        ...
        result = runner.invoke(cli, [
            ...
            '--description', 'Test consumer-aligned package'
        ])
        ...
        # Verify package structure was created
        package_path = Path('packages/domains/consumer-aligned/marketing/customer-analytics')
        assert package_path.exists()
        ...
        # Verify packages.yml includes consumer-aligned packages
        with open(package_path / 'packages.yml', 'r') as f:
            content = f.read()
            assert 'dbt-labs/metrics' in content
    ...
    def test_scaffold_domain_duplicate_error(self):
        ...
        result = runner.invoke(cli, [
            ...
            '--source-system', 'databricks',
            '--domain-name', 'test-data',
            '--description', 'Test duplicate package'
        ])
