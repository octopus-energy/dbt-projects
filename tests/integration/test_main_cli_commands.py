...
class TestProjectDiscoveryIntegration:
    ...
    def create_test_dbt_project(self, tmp_path, project_name="test_project", project_type="package"):
...
"""
    ...
    def test_project_discovery_with_packages(self, tmp_path):
        ...
        project2 = self.create_test_dbt_project(tmp_path, "project2", "package")
    ...
    def test_project_discovery_with_fabrics(self, tmp_path):
        ...
        fabric1 = self.create_test_dbt_project(tmp_path, "fabric1", "fabric")
        fabric2 = self.create_test_dbt_project(tmp_path, "fabric2", "fabric")
    ...
    def test_project_discovery_mixed_projects(self, tmp_path):
        ...
        package1 = self.create_test_dbt_project(tmp_path, "package1", "package")
        fabric1 = self.create_test_dbt_project(tmp_path, "fabric1", "fabric")
    ...
    def test_project_info_command_integration(self, tmp_path):
        ...
        project1 = self.create_test_dbt_project(tmp_path, "test_project", "package")
